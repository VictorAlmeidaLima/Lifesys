...
public class AgendadorModuloContrato implements ScheduledAction {
    @Override
    public void onTime(ScheduledActionContext scheduledActionContext) {
        ...
        try{
            codLayout = BigDecimal.valueOf(75000);
            nomeArquivo = mudaNomeArquivo("#MODULO_CONTRATO#", codLayout);
