...
public class AgendadorItemModuloContrato implements ScheduledAction {
    @Override
    public void onTime(ScheduledActionContext scheduledActionContext) {
        ...
        try{
            codLayout = BigDecimal.valueOf(79000);
            nomeArquivo = mudaNomeArquivo("#ITEM_MODULO_CONTRATO#", codLayout);
