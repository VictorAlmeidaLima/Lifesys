...
public class AgendadorVinculoClienteExclusao implements ScheduledAction {
    @Override
    public void onTime(ScheduledActionContext scheduledActionContext) {
        ...
        try{
            codLayout = BigDecimal.valueOf(88000);
            nomeArquivo = mudaNomeArquivo("#VINCULO_CLIENTE_EXC#", codLayout);
