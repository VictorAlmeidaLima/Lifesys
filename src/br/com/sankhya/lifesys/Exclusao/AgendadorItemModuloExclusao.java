...
public class AgendadorItemModuloExclusao implements ScheduledAction {
    @Override
    public void onTime(ScheduledActionContext scheduledActionContext) {
        ...
        try{
            codLayout = BigDecimal.valueOf(86000);
            nomeArquivo = mudaNomeArquivo("#ITEM_MODULO_EXC#", codLayout);
