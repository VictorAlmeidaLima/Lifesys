...
public class AgendadorPagamentoExclusao implements ScheduledAction {
    @Override
    public void onTime(ScheduledActionContext scheduledActionContext) {
        ...
        try{
            codLayout = BigDecimal.valueOf(84000);
            nomeArquivo = mudaNomeArquivo("#PAGAMENTO_EXC#", codLayout);
