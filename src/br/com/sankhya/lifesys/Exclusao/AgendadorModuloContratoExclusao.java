...
public class AgendadorModuloContratoExclusao implements ScheduledAction {
    @Override
    public void onTime(ScheduledActionContext scheduledActionContext) {
        ...
        try{
            codLayout = BigDecimal.valueOf(82000);
            nomeArquivo = mudaNomeArquivo("#MODULO_CONTRATO_EXC#", codLayout);
