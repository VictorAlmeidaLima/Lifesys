...
public class ReiniciarIntegracaoCliente implements AcaoRotinaJava {
    Logger log = Logger.getLogger(ReiniciarIntegracaoCliente.class.getSimpleName());
    ...
    public void reiniciaIntegracao(ContextoAcao contextoAcao) throws Exception {
        ...
        BigDecimal p_codlayout = BigDecimal.valueOf(71000);
