...
public class ReiniciarIntegracaoContrato implements AcaoRotinaJava {
    Logger log = Logger.getLogger(ReiniciarIntegracaoContrato.class.getSimpleName());
    ...
    public void reiniciaIntegracao(ContextoAcao contextoAcao) throws Exception {
        ...
        BigDecimal p_codlayout = BigDecimal.valueOf(73000);
