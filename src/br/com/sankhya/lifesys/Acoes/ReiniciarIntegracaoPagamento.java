...
public class ReiniciarIntegracaoPagamento implements AcaoRotinaJava {
    Logger log = Logger.getLogger(ReiniciarIntegracaoPagamento.class.getSimpleName());
    ...
    public void reiniciaIntegracao(ContextoAcao contextoAcao) throws Exception {
        ...
        BigDecimal p_codlayout = BigDecimal.valueOf(76000);
